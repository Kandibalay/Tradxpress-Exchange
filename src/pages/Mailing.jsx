...
const Mailing = () => {
  ...
  return (
    <div className='bg-[#FBF8FD] w-[90%] md:w-[60%] lg:w-[40%] mx-auto my-12 px-10 py-8 shadow-md flex flex-col gap-7 items-center justify-center' >
        ...
        <h3 className='font-semibold'>Welcome Iretiayo</h3>
        <img src={Mail} alt="" className='w-[100px]' />
        <p className='text-center text-[14px]'>An activation link has been sent to {} Please click on the link to verify your email and activate your TradExpress account.</p>
